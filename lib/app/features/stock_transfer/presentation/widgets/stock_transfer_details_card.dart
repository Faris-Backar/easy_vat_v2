...
class StockTransferDetailsCard extends StatefulWidget {
  final StockTransferCartEntity items;
  final int index;
  const StockTransferDetailsCard(
      {super.key, required this.items, required this.index});

  @override
  State<StockTransferDetailsCard> createState() =>
      _StockTransferDetailsCardState();
}

class _StockTransferDetailsCardState extends State<StockTransferDetailsCard> {
