...
class StockTransferBottomModelSheet extends ConsumerStatefulWidget {
  const StockTransferBottomModelSheet({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _StockTransferBottomModalSheetState();
}

class _StockTransferBottomModalSheetState
    extends ConsumerState<StockTransferBottomModelSheet> {
        ...
        children: [
          ...
          Expanded(
            child: state.map(
                ...
                failure: (value) => const SizedBox.shrink()),
          ),
...
Future<void> showStockTransferItemsBottomSheet(BuildContext context) async {
  await showModalBottomSheet(
      ...
      builder: (context) {
        return StockTransferBottomModelSheet();
      });
}
