...
class StockTransferAppbar extends ConsumerStatefulWidget
    implements PreferredSizeWidget {
  final TextEditingController searchController;
  final StockTransferAppBarConfig config;

  const StockTransferAppbar(
      {super.key, required this.searchController, required this.config});

  @override
  ConsumerState<StockTransferAppbar> createState() =>
      _StockTransferAppBarState();
...
class StockTransferAppBarConfig {
  ...
  const StockTransferAppBarConfig(
      {this.title = "",
    ...
    return PopScope(
      ...
      child: AppBar(
        ...
        title: Text(widget.config.title.isNotEmpty
            ? widget.config.title
            : context.translate(AppStrings.stockTransfer)),
        actions: [
