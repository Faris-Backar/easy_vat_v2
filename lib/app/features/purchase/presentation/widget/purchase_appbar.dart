...
/// Generic Purchase App Bar for various sales-related screens
class PurchaseAppBar extends ConsumerStatefulWidget
    implements PreferredSizeWidget {
  /// Controller for the search input
  final TextEditingController searchController;

  /// Configuration options for the app bar
  final PurchaseAppBarConfig config;
  ...
  @override
  ConsumerState<PurchaseAppBar> createState() => _PurchaseAppBarState();

  @override
  Size get preferredSize => Size.fromHeight(123.h + kToolbarHeight);
}

/// Configuration class for customizing the PurchaseAppBar
class PurchaseAppBarConfig {
...
class _PurchaseAppBarState extends ConsumerState<PurchaseAppBar> {
                  ...
                  child: paymentModeState.when(
                    ...
                    loaded: (paymentModes, selectedPaymentMode) {
                      return DropdownField(
                        ...
                        valueNotifier: purchaseModeNotifier,
                        items: paymentModes
                        ...
                        onChanged: (newValue) {
                          purchaseModeNotifier.value = newValue;
                        },
                      );
                    },
                  ),
    ...
    return PopScope(
      ...
      child: AppBar(
        ...
        title: Text(widget.config.title.isNotEmpty
            ? widget.config.title
            : context.translate(AppStrings.purchaseInvoice)),
        actions: [
