...
class _PurchaseReturnScreenState extends ConsumerState<PurchaseReturnScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback(
      (_) async {
        ...
        ref.read(fetchPurchaseReturnProvider.notifier).fetchPurchaseReturn(
  ...
  Widget build(BuildContext context) {
    final purchaseInvoiceState = ref.watch(fetchPurchaseReturnProvider);
    return Scaffold(
      ...
      body: Consumer(builder: (context, ref, child) {
        ...
        return Padding(
          ...
          child: purchaseInvoiceState.maybeWhen(
            success: (purchaseReturnData, totalAmount) {
              if (purchaseReturnData.isEmpty == true) {
                return Center(
                  child: Container(
                    height: 0.5.sh,
                    width: 0.8.sw,
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  final purchaseReturn = purchaseReturnData[index];
                  ...
                  return Padding(
                    ...
                    child: Slidable(
                            ...
                            child: _buildSlidingAction(
                                ...
                                onTap: () async {
                                  context.router.push(PdfViewerRoute(
                                      ...
                                      pdfName: purchaseReturn.supplierName));
                                }),
                          ),
                          Expanded(
                            child: _buildSlidingAction(
                      ...
                      child: CustomTransactionCard(
                        ...
                        transactionTitle: AppStrings.purchaseNo,
                        referenceTitle: AppStrings.refNo,
                        date: purchaseReturn.purchaseReturnDate,
                        discount: purchaseReturn.discount,
                        grossAmount: purchaseReturn.grossAmount,
                        netAmount: purchaseReturn.netTotal,
                        paymentMethod:
                            purchaseReturn.purchaseReturnMode ?? "cash",
                        referenceNo: purchaseReturn.referenceNo,
                        title: purchaseReturn.supplierName,
                        tax: purchaseReturn.tax,
                        transactionBy: "",
                        transactionId:
                            purchaseReturn.purchaseReturnNo?.toString(),
                      ),
                    ),
                  );
                },
  ...
  void _showDeleteDialog(BuildContext context,
      {required String purchaseReturnIdpk,
      String? supplierIdpk,
      String? purchasedBy}) {
    showDialog(
        context: context,
        builder: (context) => CustomConfirmationDialog(
              ...
              onPrimaryTap: () {
                ...
                log("purchase return params => ${params.toJson()}");
                ref
                    .read(deletePurchaseProvider.notifier)
                    .deletePurchaseReturn(params: params);
