...
class CreditNoteLedgerCardWidget extends StatefulWidget {
  final CreditNoteCartEntity ledger;
  final int index;
  const CreditNoteLedgerCardWidget(
      {super.key, required this.ledger, required this.index});

  @override
  State<CreditNoteLedgerCardWidget> createState() =>
      _CreditNoteLedgerCardWidgetState();
}

class _CreditNoteLedgerCardWidgetState
    extends State<CreditNoteLedgerCardWidget> {
              ...
              children: [
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: context.textTheme.bodySmall?.copyWith(
                              ...
                              color: widget.ledger.ledgerBalance >= 0
                                  ? Colors.green
                                  : context.errorColor),
                        )
                      ],
                ...
                Row(
                  ...
                  children: [
                    ...
                    _buildHeaderText(context.translate(AppStrings.drAmount),
                        flex: 3),
                    const SizedBox(
                      width: 2,
                    ),
                ...
                Row(
                  children: [
                    ...
                    _buildValueText(widget.ledger.drAmount.toStringAsFixed(2),
                        flex: 2, textAlign: TextAlign.start),
                    _buildValueText(
