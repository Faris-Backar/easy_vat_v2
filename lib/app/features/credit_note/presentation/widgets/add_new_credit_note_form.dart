...
class AddNewCreditNoteForm extends ConsumerStatefulWidget {
  ...
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _AddNewCreditNoteFormState();
}

class _AddNewCreditNoteFormState extends ConsumerState<AddNewCreditNoteForm> {
                ...
                children: [
                  SizedBox(
                    child: CustomTextField(
                      label: context.translate(AppStrings.creditNoteNo),
                      controller: widget.creditNoteNoController,
                      height: 38.h,
                      labelAndTextfieldGap: 2,
                      hint: context.translate(AppStrings.creditNoteNo),
