...
class LedgerGroupAppbar extends ConsumerStatefulWidget
    implements PreferredSizeWidget {
  final TextEditingController searchController;
  final LedgerGroupAppBarConfig config;
  const LedgerGroupAppbar(
      {super.key, required this.searchController, required this.config});

  @override
  ConsumerState<LedgerGroupAppbar> createState() => _LedgerGroupAppbarState();

  @override
  Size get preferredSize => Size.fromHeight(60.h + kToolbarHeight);
}

class LedgerGroupAppBarConfig {
  final String title;
...
class _LedgerGroupAppbarState extends ConsumerState<LedgerGroupAppbar> {
  late final ValueNotifier<bool> isSearchNotEmpty;
  DateTime? selectedLedgerGroupDate;
        ...
        Expanded(
          ...
          child: ValueListenableBuilder<bool>(
              ...
              builder: (_, hasText, __) => TextInputFormField(
                  ...
                  onChanged: (value) {}, // search Ledger group
                  suffixIcon: Row(
    ...
    return PopScope(
      ...
      child: AppBar(
        ...
        title: Text(widget.config.title.isNotEmpty
            ? widget.config.title
            : context.translate(AppStrings.ledgerGroup)),
        actions: [
