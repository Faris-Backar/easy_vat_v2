...
_$SalesInvoiceRequestModelImpl _$$SalesInvoiceRequestModelImplFromJson(
    ...
    _$SalesInvoiceRequestModelImpl(
      ...
      cashAmount: (json['cashAmount'] as num).toInt(),
      creditCardAmount: (json['creditCardAmount'] as num).toInt(),
      actualSalesDate: DateTime.parse(json['actualSalesDate'] as String),
      ...
      roundOff: (json['roundOff'] as num).toInt(),
