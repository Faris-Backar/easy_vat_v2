...
class _SalesOrderScreenState extends ConsumerState<SalesOrderScreen> {
  ...
  late SalesOrderState salesOrderState;
  bool isTaxRegisrationEnabled = false;

  @override
  void initState() {
    super.initState();
    salesOrderState = ref.read(salesOrderNotifierProvider);
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      ref.read(salesOrderNotifierProvider.notifier).fetchSalesOrder(
            params: SalesParams(
    ...
    return Scaffold(
      ...
      body: Consumer(builder: (context, ref, child) {
        ...
        return Padding(
          ...
          child: salesOrderState.maybeWhen(
            success: (salesOrderData, totalAmount) {
              if (salesOrderData.isEmpty == true) {
                return Center(
                  child: Container(
                    height: 0.5.sh,
                    width: 0.8.sw,
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  final salesOrder = salesOrderData[index];
                  ...
                  return Padding(
                    ...
                    child: Slidable(
                        ...
                        Expanded(
                          child: _buildSlidingAction(
                            ...
                            onTap: () => _showDeleteDialog(context,
                                salesIdpk: salesOrder.salesOrderIdpk ?? "",
                                customerID: salesOrder.customerIdpk ?? ""),
                          ),
                        ),
                      ]),
                      child: CustomTransactionCard(
                        ...
                        amount: salesOrder.grossTotal,
                        date: salesOrder.salesOrderDate,
                        discount: salesOrder.dsicount,
                        grossAmount: salesOrder.grossTotal,
                        netAmount: salesOrder.netTotal,
                        // paymentMethod: salesOrder.sales ?? "",
                        transactionTitle: AppStrings.salesOrder,
                        transactionId:
                            salesOrder.quotationNo?.toString() ?? "0",
