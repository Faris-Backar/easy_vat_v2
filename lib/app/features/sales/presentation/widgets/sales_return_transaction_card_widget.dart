...
class SalesReturnTransactionCard extends StatelessWidget {
  final SalesReturnEntity salesreturn;

  const SalesReturnTransactionCard({super.key, required this.salesreturn});

  // Get status color based on sales invoice status
  Color _getStatusColor(BuildContext context) {
    // Replace this with your actual status field from SalesreturnListEntity
    final status = "paid";
                  ...
                  Expanded(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 3),
                        Text(
                          salesreturn.salesReturnNo?.toString() ?? "",
                          style: context.textTheme.bodySmall?.copyWith(
                            fontSize: 11,
                      ...
                      children: [
                        ...
                        Text(
                          DateFormatUtils.getFormettedTime(
                              date: salesreturn.returnDate ?? DateTime.now()),
                          style: context.textTheme.bodySmall?.copyWith(
                            fontSize: 11,
                            fontWeight: FontWeight.w600,
                            color: context.defaultTextColor
                  ...
                  Expanded(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 3),
                        Text(
                          salesreturn.netTotal?.toStringAsFixed(2) ?? "",
                          style: context.textTheme.bodySmall?.copyWith(
                            fontSize: 11,
                            fontWeight: FontWeight.w600,
                            color: context.defaultTextColor
