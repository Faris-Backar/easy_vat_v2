...
mixin _$ItemState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<ItemEntity> itemsList) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<ItemEntity> itemsList)? loaded,
...
abstract class _$$LoadedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<ItemEntity> itemsList});
}
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl({required final List<ItemEntity> itemsList})
      : _itemsList = itemsList;

  final List<ItemEntity> _itemsList;
  @override
  ...
  @override
  String toString() {
    return 'ItemState.loaded(itemsList: $itemsList)';
  }
...
abstract class _Loaded implements ItemState {
  const factory _Loaded({required final List<ItemEntity> itemsList}) =
      _$LoadedImpl;
