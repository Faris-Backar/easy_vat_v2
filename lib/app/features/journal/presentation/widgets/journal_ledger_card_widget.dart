...
class JournalLedgerCardWidget extends ConsumerStatefulWidget {
  final JournalCartEntity ledger;
  final int index;

  const JournalLedgerCardWidget({
    super.key,
  ...
  @override
  ConsumerState<JournalLedgerCardWidget> createState() =>
      _JournalLedgerCardWidgetState();
}

class _JournalLedgerCardWidgetState
    extends ConsumerState<JournalLedgerCardWidget> {
