    ...
    return AlertDialog(
      ...
      title: Row(
        ...
        children: [
          ...
          //       return entryMode == "Double Entry"
          //           ? Expanded(
          //               child: DropdownField(
          //                   label: context.translate(AppStrings.ledgerMode),
          //                   valueNotifier: widget.ledgerModeNotifier,
          //                   items: ["Debit Ledger", "Credit Ledger"],
          //                   onChanged: (newValue) {
          //                     widget.ledgerModeNotifier.value = newValue;
          //                   }),
          //             )
          ...
          children: [
            ...
            Row(
              children: [
                ...
                //                     TextSelection(
                //                         baseOffset: 0,
                //                         extentOffset: _totalAmountController
                //                             .value.text.length),
                //                 maxLines: 1,
                //                 controller: _totalAmountController,
                //                 fillColor:
                ...
                //         ),
                //       );
                //     } else if (entryMode == "Double Entry") {
                //       return Expanded(
                //         child: ValueListenableBuilder<String?>(
                //           valueListenable: widget.ledgerModeNotifier,
                //           builder: (context, ledgerMode, _) {
                //             if (ledgerMode == "Debit Ledger") {
                //               return Row(
                //                 children: [
                //                   SizedBox(
                //                     width: 100.w,
                ...
                //                           TextSelection(
                //                               baseOffset: 0,
                //                               extentOffset: _drAmountController
                //                                   .value.text.length),
                //                       maxLines: 1,
                //                       controller: _drAmountController,
                //                       fillColor:
                ...
                //                 ],
                //               );
                //             } else if (ledgerMode == "Credit Ledger") {
                //               return Row(
                //                 children: [
                //                   SizedBox(
                //                     width: 100.w,
                ...
                //                           TextSelection(
                //                               baseOffset: 0,
                //                               extentOffset: _crAmountController
                //                                   .value.text.length),
                //                       maxLines: 1,
                //                       controller: _crAmountController,
                //                       fillColor:
