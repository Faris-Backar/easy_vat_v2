...
class JournalBottomModalSheet extends ConsumerStatefulWidget {
  ...
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _JournalBottomModalSheetState();
}

class _JournalBottomModalSheetState
    extends ConsumerState<JournalBottomModalSheet> {
  final TextEditingController searchController = TextEditingController();
  final ValueNotifier<int?> journalDetailsExpansionNotifier =
      ValueNotifier(null);
...
Future<void> showLedgerBottomSheet(
  ...
  await showModalBottomSheet(
      ...
      builder: (context) {
        return JournalBottomModalSheet();
      });
}
