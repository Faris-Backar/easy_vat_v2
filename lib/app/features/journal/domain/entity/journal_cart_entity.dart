...
class JournalCartEntity {
  ...
  @override
  String toString() {
    return "JournalCartEntity(ledgerId: $ledgerId, currentBalance: $currentBalance, ledger: $ledger, netTotal: $netTotal, drAmount = $drAmount, crAmount = $crAmount, description: $description)";
  }
}
