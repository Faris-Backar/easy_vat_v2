...
class SupplierInfoWidget extends ConsumerStatefulWidget {
  const SupplierInfoWidget({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _SupplierInfoWidgetState();
}
  ...
  Widget _buildSupplierbottomSheet(
    ...
    return Consumer(
      builder: (context, ref, child) {
        final supplierState =
            ref.watch(supplierNotfierProvider); // suppiler state
        return Container(
          height: 1.sh,
