...
class CustomerAppbar extends ConsumerStatefulWidget
    implements PreferredSizeWidget {
  final TextEditingController searchController;
  final CustomerAppBarConfig config;
  const CustomerAppbar(
      {super.key, required this.searchController, required this.config});

  @override
  ConsumerState<CustomerAppbar> createState() => _CustomerAppbarState();

  @override
  Size get preferredSize => Size.fromHeight(60.h + kToolbarHeight);
}

class CustomerAppBarConfig {
  final String title;
...
class _CustomerAppbarState extends ConsumerState<CustomerAppbar> {
        ...
        Expanded(
          ...
          child: ValueListenableBuilder<bool>(
              ...
              builder: (_, hasText, __) => TextInputFormField(
                  ...
                  onChanged: (value) {}, // search Customer
                  suffixIcon: Row(
