...
import 'package:easy_vat_v2/app/features/contra/presentation/widgets/contra_ledger_card_widget.dart';
...
class ContraCartList extends StatelessWidget {
  final List<ContraCartEntity> ledgerList;
  const ContraCartList({super.key, required this.ledgerList});
  ...
  Widget _buildSlidableLedger(BuildContext context, index) {
    return Slidable(
      ...
      child: InkWell(
        ...
        child: ContraLedgerCardWidget(ledger: ledgerList[index], index: index),
      ),
    );
  }
                      ...
                      return PrimaryButton(
                        ...
                        onPressed: () {
                          ref
                              ...
                              .removeLedgerFromContraCart(index: index);
                    ...
                    Expanded(child:
                      ...
                      return PrimaryButton(
                        ...
                        onPressed: () {
                          ...
                          ref
                              .read(contraCartProvider.notifier)
                              .updateContraCartLedger(cartLedger: updatedLdger);
                          context.router.popForced();
                        },
                      );
                    }))
