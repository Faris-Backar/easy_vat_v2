...
class ContraAppbar extends ConsumerStatefulWidget
    implements PreferredSizeWidget {
  final TextEditingController searchController;
  final ContraAppBarConfig config;

  const ContraAppbar(
      {super.key, required this.searchController, required this.config});

  @override
  ConsumerState<ContraAppbar> createState() => _ContraAppBarState();
...
class _ContraAppBarState extends ConsumerState<ContraAppbar> {
    ...
    return PopScope(
      ...
      child: AppBar(
        ...
        title: Text(widget.config.title.isNotEmpty
            ? widget.config.title
            : context.translate(AppStrings.contra)),
        actions: [
