...
class IncomeAppbar extends ConsumerStatefulWidget
    implements PreferredSizeWidget {
  final TextEditingController searchController;
  final IncomeAppBarConfig config;

  const IncomeAppbar(
      {super.key, required this.searchController, required this.config});

  @override
  ConsumerState<IncomeAppbar> createState() => _IncomeAppBarState();
    ...
    return PopScope(
        ...
        child: AppBar(
          ...
          title: Text(widget.config.title.isNotEmpty
              ? widget.config.title
              : context.translate(AppStrings.income)),
          actions: [
                      ...
                      ...widget.config.additionalPopupMenuItems ??
                          [
                            ...
                            PopupMenuItem(
                                ...
                                child: _popupItem(context
                                    .translate(AppStrings.downloadExcel))),
                            PopupMenuItem(
