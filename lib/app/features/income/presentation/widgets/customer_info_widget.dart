...
class _CustomerInfoWidgetState extends ConsumerState<CustomerInfoWidget> {
  ...
  Future<void> _fetchAndSelectCustomer() async {
    final selectedCustomer = ref.read(incomeCartProvider).selectedCustomer;
    if (selectedCustomer != null) {
      ref.read(incomeCartProvider.notifier).setCustomer(selectedCustomer);
      billingAddressController.text =
          ref.read(incomeCartProvider).selectedCustomer?.billingAddress ?? "";
                ...
                Expanded(
                    child: ValueListenableBuilder<int?>(
                        ...
                        builder: (_, expandedIndex, __) => ListView.separated(
                              ...
                              itemCount:
                                  customerState.customerList?.length ?? 0,
                              itemBuilder: (_, index) {
                                final customer =
                      ...
                      child: SecondaryButton(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(context.translate(AppStrings.addCustomer),
  ...
  Widget _buildCustomerTabView(BuildContext context) {
    final selectedCustomer = ref.watch(incomeCartProvider).selectedCustomer;
                    ...
                    children: [
                      InkWell(
                        onTap: () {
                          showModalBottomSheet(
                            ...
                            backgroundColor: AppUtils.isDarkMode(context)
                                ...
                                : context.colorScheme.surfaceContainerLowest,
                            builder: (context) =>
                                _buildCustomerBottomSheet(context),
                          ).whenComplete(() {
                        ...
                        child: CustomerInfoTabContent(
                          ...
                          outstandingAmount: selectedCustomer?.creditLimit
                                  ?.toStringAsFixed(2) ??
                              "0.0",
                          creditDays:
                      ...
                      InkWell(
                        ...
                        child: CustomerAddressInfo(
                            ...
                            label: context
                                .translate(AppStrings.enterBillingAddress)),
                      ),
                      InkWell(
                        onTap: () {
                          showModalBottomSheet(
