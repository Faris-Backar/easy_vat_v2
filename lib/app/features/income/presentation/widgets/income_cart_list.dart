...
import 'package:easy_vat_v2/app/features/income/presentation/widgets/income_ledger_card_widget.dart';
...
class IncomeCartList extends StatelessWidget {
  final List<IncomeCartEntity> ledgerList;
  const IncomeCartList({super.key, required this.ledgerList});
  ...
  Widget _buildSlidableLedger(BuildContext context, int index) {
    return Slidable(
      ...
      child: InkWell(
        onTap: () => showDialog(
            context: context,
            builder: (context) => IncomeAddDialog(
                  ledger: ledgerList[index].ledger,
                  ledgerEntry: ledgerList[index],
                )),
        child: IncomeLedgerCardWidget(ledger: ledgerList[index], index: index),
      ),
    );
  }
                      ...
                      return PrimaryButton(
                        ...
                        onPressed: () {
                          ref
                              ...
                              .removeLedgerFromIncomeCart(index: index);
                    ...
                    Expanded(child:
                      ...
                      return PrimaryButton(
                        ...
                        onPressed: () {
                          ...
                          ref
                              .read(incomeCartProvider.notifier)
                              .updateIncomeCartLedger(cartLedger: updatedLdger);
                          context.router.popForced();
                        },
                      );
                    }))
