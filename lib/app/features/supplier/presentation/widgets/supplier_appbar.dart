...
class SupplierAppbar extends ConsumerStatefulWidget
    implements PreferredSizeWidget {
  final TextEditingController searchController;
  final SupplierAppBarConfig config;
  const SupplierAppbar(
      {super.key, required this.searchController, required this.config});

  @override
  ConsumerState<SupplierAppbar> createState() => _SupplierAppbarState();

  @override
  Size get preferredSize => Size.fromHeight(60.h + kToolbarHeight);
}

class SupplierAppBarConfig {
  final String title;
...
class _SupplierAppbarState extends ConsumerState<SupplierAppbar> {
        ...
        Expanded(
          ...
          child: ValueListenableBuilder<bool>(
              ...
              builder: (_, hasText, __) => TextInputFormField(
                  ...
                  onChanged: (value) {}, // search  Supplier
                  suffixIcon: Row(
