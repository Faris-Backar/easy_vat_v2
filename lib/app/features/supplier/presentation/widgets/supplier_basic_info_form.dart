...
class SupplierBasicInfoForm extends ConsumerStatefulWidget {
  const SupplierBasicInfoForm({super.key});

  @override
  ConsumerState<SupplierBasicInfoForm> createState() =>
      _SupplierBasicInfoFormState();
}

class _SupplierBasicInfoFormState extends ConsumerState<SupplierBasicInfoForm> {
  @override
