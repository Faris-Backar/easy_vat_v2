...
class DividendAppbar extends ConsumerStatefulWidget
    implements PreferredSizeWidget {
  final TextEditingController searchController;
  final DividendAppBarConfig config;

  const DividendAppbar(
      {super.key, required this.searchController, required this.config});

  @override
  ConsumerState<DividendAppbar> createState() => _DividendAppBarState();
...
class _DividendAppBarState extends ConsumerState<DividendAppbar> {
    ...
    return PopScope(
      ...
      child: AppBar(
        ...
        title: Text(widget.config.title.isNotEmpty
            ? widget.config.title
            : context.translate(AppStrings.dividend)),
        actions: [
