...
import 'package:easy_vat_v2/app/features/dividend/presentation/widgets/dividend_ledger_card_widget.dart';
...
class DividendCartList extends StatelessWidget {
  final List<DividendCartEntity> ledgerList;
  const DividendCartList({super.key, required this.ledgerList});
  ...
  Widget _buildSlidableLedger(BuildContext context, int index) {
    return Slidable(
      ...
      child: InkWell(
        ...
        child:
            DividendLedgerCardWidget(ledger: ledgerList[index], index: index),
      ),
    );
  }
                      ...
                      return PrimaryButton(
                        ...
                        onPressed: () {
                          ref
                              ...
                              .removeLedgerFromDividendCart(index: index);
