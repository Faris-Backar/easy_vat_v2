...
class DebitNoteLedgerCardWidget extends StatefulWidget {
  final DebitNoteCartEntity ledger;
  final int index;
  const DebitNoteLedgerCardWidget(
      {super.key, required this.ledger, required this.index});

  @override
  State<DebitNoteLedgerCardWidget> createState() =>
      _DebitNoteLedgerCardWidgetState();
}

class _DebitNoteLedgerCardWidgetState extends State<DebitNoteLedgerCardWidget> {
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    //   width: 8,
                    // ),
                    _buildValueText(widget.ledger.crAmount.toStringAsFixed(2),
