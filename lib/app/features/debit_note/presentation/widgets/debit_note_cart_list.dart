...
import 'package:easy_vat_v2/app/features/debit_note/presentation/widgets/debit_note_ledger_card_widget.dart';
...
class DebitNoteCartList extends StatelessWidget {
  final List<DebitNoteCartEntity> ledgerList;
  const DebitNoteCartList({super.key, required this.ledgerList});
  ...
  Widget _buildSlidableLedger(BuildContext context, int index) {
    return Slidable(
      ...
      child: InkWell(
        onTap: () => showDialog(
          context: context,
          builder: (context) => DebitNoteLedgerAddDialog(
            ledger: ledgerList[index].ledger,
            ledgerEntry: ledgerList[index],
          ),
        ),
        child:
            DebitNoteLedgerCardWidget(ledger: ledgerList[index], index: index),
      ),
    );
  }
                      ...
                      return PrimaryButton(
                        ...
                        onPressed: () {
                          ref
                              ...
                              .removeLedgerFromDebitNoteCart(index: index);
