...
class DebitNoteAppbar extends ConsumerStatefulWidget
    implements PreferredSizeWidget {
  final TextEditingController searchController;
  final DebitNoteAppBarConfig config;

  const DebitNoteAppbar(
      {super.key, required this.searchController, required this.config});

  @override
  ConsumerState<DebitNoteAppbar> createState() => _DebitNoteAppBarState();
    ...
    return PopScope(
      ...
      child: AppBar(
        ...
        title: Text(widget.config.title.isNotEmpty
            ? widget.config.title
            : context.translate(AppStrings.debitNote)),
        actions: [
