...
class BankAppbar extends ConsumerStatefulWidget implements PreferredSizeWidget {
  final TextEditingController searchController;
  final BankAppBarConfig config;
  const BankAppbar(
      {super.key, required this.config, required this.searchController});

  @override
  ConsumerState<BankAppbar> createState() => _BankAppbarState();

  @override
  Size get preferredSize => Size.fromHeight(60.h + kToolbarHeight);
}

class BankAppBarConfig {
  final String title;
...
class _BankAppbarState extends ConsumerState<BankAppbar> {
    ...
    return PopScope(
      ...
      child: AppBar(
        ...
        title: Text(widget.config.title.isNotEmpty
            ? widget.config.title
            : context.translate(AppStrings.bank)),
        actions: [
