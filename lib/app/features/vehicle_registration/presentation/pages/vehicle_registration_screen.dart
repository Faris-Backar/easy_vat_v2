...
import 'package:easy_vat_v2/app/features/vehicle_registration/presentation/widgets/vehicle_registration_appbar.dart';
...
class _VehicleRegistrationScreenState
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: VehicleRegistrationAppbar(
          searchController: _searchTextController,
          config: VehicleRegistrationAppbarConfig()),
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              PrimaryButton(
                onPressed: () =>
                    context.router.push(AddNewVehicleRegistration()),
                child: Row(
