...
class VehicleRegistrationAppbar extends ConsumerStatefulWidget
    implements PreferredSizeWidget {
  final TextEditingController searchController;
  final VehicleRegistrationAppbarConfig config;
  const VehicleRegistrationAppbar(
      {super.key, required this.searchController, required this.config});

  @override
  ConsumerState<VehicleRegistrationAppbar> createState() =>
      _VehicleRegistrationAppbarState();

  @override
  Size get preferredSize => Size.fromHeight(60.h + kToolbarHeight);
}

class VehicleRegistrationAppbarConfig {
  final String title;
  ...
  const VehicleRegistrationAppbarConfig(
      {this.title = "",
...
class _VehicleRegistrationAppbarState
    extends ConsumerState<VehicleRegistrationAppbar> {
        ...
        Expanded(
          ...
          child: ValueListenableBuilder<bool>(
              ...
              builder: (_, hasText, __) => TextInputFormField(
                  ...
                  onChanged: (value) {}, // search  Vehicle Registration
                  suffixIcon: Row(
    ...
    return PopScope(
      ...
      child: AppBar(
        ...
        title: Text(widget.config.title.isNotEmpty
            ? widget.config.title
            : context.translate(AppStrings.vehicleRegistration)),
        actions: [
