...
class LedgerAppbar extends ConsumerStatefulWidget
    implements PreferredSizeWidget {
  final TextEditingController searchController;
  final LedgerAppBarConfig config;
  const LedgerAppbar(
      {super.key, required this.searchController, required this.config});

  @override
  ConsumerState<LedgerAppbar> createState() => _LedgerAppbarState();

  @override
  Size get preferredSize => Size.fromHeight(60.h + kToolbarHeight);
}

class LedgerAppBarConfig {
  final String title;
...
class _LedgerAppbarState extends ConsumerState<LedgerAppbar> {
  late final ValueNotifier<bool> isSearchNotEmpty;
  DateTime? selectedLedgerDate;
