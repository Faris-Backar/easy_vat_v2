...
class CustomColors {
  static Color getTransactionCardGreyColor(BuildContext context) {
    return AppUtils.isDarkMode(context) ? Color(0xFF242425) : Color(0xFFEFEEEF);
  }
  ...
  static Color getTransactionSkyBlueColor(BuildContext context) {
    return AppUtils.isDarkMode(context) ? Color(0xFF4A9FB6) : Color(0xFF157BB0);
  }

  static Color getTransactionCardBlueColor(BuildContext context) {
    return AppUtils.isDarkMode(context) ? Color(0xFF3B3487) : Color(0xFF2E3EBF);
  }
  ...
  static Color activeGreenColor(BuildContext context) {
    return AppUtils.isDarkMode(context) ? Color(0xFF348740) : Color(0xFF348740);
  }

  static Color inActiveRedColor(BuildContext context) {
    return AppUtils.isDarkMode(context) ? Color(0xFFE51717) : Color(0xFFE51717);
  }

  static Color getSurfaceLowestColor(BuildContext context) {
    return AppUtils.isDarkMode(context)
